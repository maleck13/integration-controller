...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IntegrationMetaData) DeepCopyInto(out *IntegrationMetaData) {
	*out = *in
	if in.Secrets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IntegrationMetaData.
func (in *IntegrationMetaData) DeepCopy() *IntegrationMetaData {
	if in == nil {
		return nil
	}
	out := new(IntegrationMetaData)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IntegrationStatus) DeepCopyInto(out *IntegrationStatus) {
	*out = *in
	in.IntegrationMetaData.DeepCopyInto(&out.IntegrationMetaData)
	return
}
